...
con_csv = inp_fld + 'con_rat_82_srt.csv'
m3r_ncf = inp_fld + ('vol_82.nc')
kpr_csv = inp_fld + 'k_82.csv'
xpr_csv = inp_fld + 'xfc_82.csv'
bas_csv = inp_fld + 'riv_82.csv'

ZS_dtR = 10800

Qou_ncf = out_fld + 'Qout_MS_b82_20150101_20240531_GLDASv21_ens_dtR10800.nc'
        ...
        for row in csvreader:
            ...
            for JS_ncol in range(1, IS_ncol):
                if ast.literal_eval(row[JS_ncol])[0] != 0:
                    ...
                    IS_dwn_cnt += 1
            if (len(ZV_dwn_rat_row) > 0) & (sum(ZV_dwn_rat_row) != 1):
