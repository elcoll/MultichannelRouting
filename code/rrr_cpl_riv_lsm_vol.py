...
# rrr_con_file = "../test/con_82.csv"
# rrr_crd_file = "../test/coords_82.csv"
# rrr_lsm_file = "../test/GLDAS_v21_2015_2024_ens.nc"
# rrr_cpl_file = "../test/cpl_82.csv"
# rrr_vol_file = "../test/vol_82.nc"

# python rrr_cpl_riv_lsm_vol.py \
#         /Users/elyssac/Documents/RiverRouting/inputs/b82/Main_Side/con_82.csv \
#         /Users/elyssac/Documents/RiverRouting/inputs/b82/Main_Side/coords_82.csv \
#         /Users/elyssac/Documents/RiverRouting/inputs/Runoff/GLDAS_v21_2015_2024_ens.nc \
#         /Users/elyssac/Documents/RiverRouting/inputs/b82/Main_Side/cpl_82.csv \
#         /Users/elyssac/Documents/RiverRouting/inputs/b82/Main_Side/vol_82.nc
...
with open(rrr_cpl_file) as csv_file:
     ...
     for row in reader:
          ...
          ZV_riv_sqkm.append(float(row[1]))
...
for JS_riv_tot in range(IS_riv_tot):
     if IV_riv_tot_id1[JS_riv_tot] != IV_riv_tot_id2[JS_riv_tot]:
          print(IV_riv_tot_id1[JS_riv_tot])
          print(IV_riv_tot_id2[JS_riv_tot])
          print('Error 1')
          print('ERROR - River reaches differ')
          raise SystemExit(22) 
     if IV_riv_tot_id1[JS_riv_tot] != IV_riv_tot_id3[JS_riv_tot]:
          print(IV_riv_tot_id1[JS_riv_tot])
          print(IV_riv_tot_id3[JS_riv_tot])
          print('Error 2')
          print('ERROR - River reaches differ')
          raise SystemExit(22) 
...
rivid = g.createVariable("rivid","i8",("rivid",))
...
time.long_name='time'
# time.units='seconds since 1980-01-01 00:00:00 +00:00'
time.units='seconds since 2015-01-01 00:00:00 +00:00'
time.axis='T'
...
for JS_lsm_time in range(IS_lsm_time):
     ...
     if JS_lsm_time < IS_lsm_time-1:
          ZS_TaR=f.variables['time'][JS_lsm_time+1]-f.variables['time'][JS_lsm_time]
     else:
          ZS_TaR=2678400
     ZS_scl=ZS_TaR/10800 # number 3-hourly time steps in time step
     ...
     m3_riv[JS_lsm_time,:]=ZV_riv_vol[:]*ZS_scl
